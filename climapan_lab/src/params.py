parameters = {
    ...
    "ETA_PRODUCTION_CAPITAL": ((2.15-1.0)/2.15), #parameter regulating capital production, (calibrate the x inside of (x - 1)/x) #(1, 10)
    "ETA_PRODUCTION": ((2.0-1.0)/2.0), #parameter regulating production function == might be the same value as the rho defined above #(1, 10)
