    ...
    def test_agent_attributes(self):
        ...
        if len(model.consumer_agents) > 0:
            ...
            for attr in required_attrs:
                self.assertTrue(hasattr(consumer, attr), 
                              f"Consumer missing attribute: {attr}")
        ...
        if len(model.csfirm_agents) > 0:
            ...
            for attr in required_attrs:
                self.assertTrue(hasattr(firm, attr), 
                              f"Firm missing attribute: {attr}")
...
class TestParameterStructure(unittest.TestCase):
    ...
    def test_parameter_types(self):
        ...
        for param in float_params:
            if param in params:
                self.assertIsInstance(params[param], (int, float), f"{param} should be numeric")
    ...
    def test_required_parameters(self):
        ...
        required_params = [
            ...
            'subsistenceLevelOfConsumption', 'settings'
        ]
