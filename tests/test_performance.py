...
class TestPerformance(unittest.TestCase):
    ...
    def test_repeated_runs_performance(self):
        ...
        for i, exec_time in enumerate(execution_times):
            self.assertLess(exec_time, 30, 
                           f"Run {i+1} took too long: {exec_time:.2f}s")
        ...
        if len(execution_times) > 1:
            ...
            self.assertLess(max_deviation, avg_time, 
                           "Performance is too inconsistent between runs")
...
class TestScalability(unittest.TestCase):
    ...
    def test_moderate_scale_configuration(self):
        ...
        self.assertLess(execution_time, 120, 
                       f"Moderate scale took too long: {execution_time:.2f}s")
        self.assertIsNotNone(result)
    ...
    def test_configuration_robustness(self):
        ...
        configurations = [
            ...
            {'c_agents': 15, 'capitalists': 8, 'csf_agents': 4, 'cpf_agents': 3, 'steps': 5},
            # Low agent diversity
            {'c_agents': 5, 'capitalists': 2, 'csf_agents': 1, 'cpf_agents': 1, 'steps': 5},
        ]
